...
export default class MulticlinicCheckIn extends LightningElement {
    ...
    connectedCallback() {
        console.log('We are in a checkInOutLWCComponent');
        ...
        if (this.currentObjectName != null && this.currentObjectName != undefined) {
            if (this.currentObjectName == OppAPIName || his.currentObjectName == accountAPIName) {
    ...
    createCheckInrecord(){
        ...
        const fields = {};
        if (this.currentObjectName == OppAPIName || this.currentObjectName == accountAPIName) {
