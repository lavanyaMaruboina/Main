...
export default class PartnerCheckInLwcComponent extends LightningElement {
    ...
    @track partnerCheckInLatitude;
    @track partnerCheckLongitude;
     ...
     /*   getDetails( { oppId: this.currenRecordId , userId: this.currentUserId})
        ...
        if (this.currentObjectName != null && this.currentObjectName != undefined) {
            if (this.currentObjectName == OppAPIName) {
                FIELDS_JS = [PRIMARY_CLINIC_LATITUDE, PRIMARY_CLINIC_LONGITUDE, SECONDARY_CLINIC_LATITUDE, SECONDARY_CLINIC_LONGITUDE,
                    SECONDARY_CLINIC_STREET, SECONDARY_CLINIC_CITY, SECONDARY_CLINIC_STATE,
                    OPP_OWNER, this.currentObjectName.concat('.OwnerId'),
                    this.currentObjectName.concat('.Check_In_Geolocation__Latitude__s'), 
                    this.currentObjectName.concat('.Check_In_Geolocation__Longitude__s'), 
                    this.currentObjectName.concat('.Check_In_Time__c'), this.currentObjectName.concat('.Check_Out_Time__c'), 
                    this.currentObjectName.concat('.Check_In_Count__c'),
                    this.currentObjectName.concat('.Partner_Check_In_Time__c'),
                    this.currentObjectName.concat('.Partner_Check_Out_Time__c'),
                    this.currentObjectName.concat('.Partner_Check_In_Count__c'),
                    this.currentObjectName.concat('.Partner_Check_In_Geolocation__Latitude__s'),
                    this.currentObjectName.concat('.Partner_Check_In_Geolocation__Longitude__s'),];
                console.log('Fields ' + FIELDS_JS);
            }
            else if (this.currentObjectName == accountAPIName) {
                FIELDS_JS = [ACC_OWNER,this.currentObjectName.concat('.OwnerId'),
                this.currentObjectName.concat('.Check_In_Geolocation__Latitude__s'), 
                this.currentObjectName.concat('.Check_In_Geolocation__Longitude__s'), 
                this.currentObjectName.concat('.BillingLatitude'), this.currentObjectName.concat('.BillingLongitude'), 
                this.currentObjectName.concat('.ShippingLatitude'), this.currentObjectName.concat('.ShippingLongitude'), 
                this.currentObjectName.concat('.Check_In_Time__c'), this.currentObjectName.concat('.Check_Out_Time__c'), 
                this.currentObjectName.concat('.Check_In_Count__c'),
                this.currentObjectName.concat('.Partner_Check_In_Time__c'),
                this.currentObjectName.concat('.Partner_Check_Out_Time__c'),
    ...
    wiredRecordFun({ error, data }) {
        ...
        if (data) {
            ...
            this.currentRecCheckInTime = this.currentRecord.fields.Partner_Check_In_Time__c.value;
            this.currentRecCheckOutTime = this.currentRecord.fields.Partner_Check_Out_Time__c.value;
            this.currentRecCheckInCount = this.currentRecord.fields.Partner_Check_In_Count__c.value;
            ...
            if (this.currentObjectName == OppAPIName) {
                ...
                this.oppOwnerId = getFieldValue(this.currentRecord, OPP_OWNER);
                ...
                this.accOwnerId = getFieldValue(this.currentRecord, ACC_OWNER);
            }
              ...
              //  if (this.currentObjectName == OppAPIName) {
                this.partnerCheckInLatitude = this.currentRecord.fields.Partner_Check_In_Geolocation__Latitude__s.value;
                this.partnerCheckLongitude = this.currentRecord.fields.Partner_Check_In_Geolocation__Longitude__s.value;
              //  }
                console.log('this.partnerCheckInLatitude  '+ this.partnerCheckInLatitude + ' this.partnerCheckLongitude  '+ this.partnerCheckLongitude );
            ...
            console.log('No Data returned - enterted in  error :::::' + JSON.stringify(error));
        }
    ...
    setVariablesCheckIn(success) {
        ...
        if (this.userLatitude != null && this.userLongitude != null && this.userLatitude != undefined && this.userLongitude != undefined) {
            ...
            if ((this.partnerCheckInLatitude == null || this.partnerCheckInLatitude == undefined) || 
            (this.partnerCheckInLatitude == null || this.partnerCheckInLatitude == undefined)) {
                if ((this.partnerCheckInLatitude == null || this.partnerCheckLongitude == undefined) || 
                (this.partnerCheckInLatitude == null || this.partnerCheckLongitude == undefined)) {
                ...
                else if ((this.partnerCheckInLatitude != null && this.partnerCheckInLatitude != undefined) && 
                (this.partnerCheckLongitude != null && this.partnerCheckLongitude != undefined)) {
                    this.distanceToClinicByGeoLocation = this.geoDistance(this.userLatitude, this.userLongitude, 
                        this.partnerCheckInLatitude, this.partnerCheckLongitude);// Mahesh Reddy Modified
                    if (this.distanceToClinicByGeoLocation > 700) {
                        this.displayMsgBanner = true;
                        this.displaySetLocationNCheckInBtn = true;
                        this.displayCheckOutBtn = false;
                        this.displayCheckInBtn = false;
                ...
                (((this.currentRecPrimaryLatitude != null && this.currentRecPrimaryLatitude != undefined) && (this.currentRecPrimaryLongitude != null && this.currentRecPrimaryLongitude != undefined)) || ((this.partnerCheckInLatitude != null && this.partnerCheckInLatitude != undefined) && (this.partnerCheckLongitude != null && this.partnerCheckLongitude != undefined)))
                &&
                ...
                if ((this.currentRecPrimaryLatitude != null && this.currentRecPrimaryLatitude != undefined) && (this.currentRecPrimaryLongitude != null && this.currentRecPrimaryLongitude != undefined)) {
                    ...
                    this.distanceToClinicByAddress = this.geoDistance(this.userLatitude, this.userLongitude, this.partnerCheckInLatitude, this.partnerCheckLongitude);
                }
                console.log('Allowed Distance :: ' + allowedRadiusLabel + '::: Actual Distance::: ' + this.distanceToClinicByAddress);
                console.log('=============='+this.distanceToClinicByGeoLocation);

                console.log('chai this.distanceToClinicByAddress >>>'+ this.distanceToClinicByAddress);
                console.log('chai allowedRadiusLabel >>>'+ allowedRadiusLabel);
                this.distanceToClinicByGeoLocation = this.geoDistance(this.userLatitude, this.userLongitude,
                                                        this.partnerCheckInLatitude, this.partnerCheckLongitude);
                if (this.distanceToClinicByGeoLocation > allowedRadiusLabel) {
                       console.log('within 700 meters allowed=====================');
                    this.displayCheckInBtnWithoutGeolocationCaptured = false;
                    this.displayMsgBanner = true;
                    this.displayCheckOutBtn = false;
                    this.displayCheckInBtn = false;
                ...
                //         this.displayCheckInBtn = false;
                //         this.displaySetLocationNCheckInBtn = false;
                //         this.displayMsg = 'your more than 700 m away from the lat/long';
                //         console.log('error point more than 700 meters');
                ...
                if ((this.currentRecCheckInTime == null || this.currentRecCheckInTime == undefined) && (this.currentRecCheckOutTime == null || this.currentRecCheckOutTime == undefined)) {
                    this.distanceToClinicByAddress = this.geoDistance(this.userLatitude, this.userLongitude, this.currentRecPrimaryLatitude, this.currentRecPrimaryLongitude);
                    console.log('Distance to first clinic :::' + this.distanceToClinicByAddress, this.userLatitude, this.userLongitude, this.currentRecPrimaryLatitude, this.currentRecPrimaryLongitude);
                    ...
                    console.log('Distance to second clinic :::' + this.distanceToSecondaryClinic, this.userLatitude, this.userLongitude, this.currentRecSecondaryLatitude, this.currentRecSecondaryLongitude);
    ...
    createCheckInrecord(){
        ...
        if (this.currentObjectName == OppAPIName) {
            ...
            if(this.oppOwnerId != this.userId){
                fields['Is_Partner_Check_In__c'] = true;
            }
            }else{
                fields['Go_Live_Doctor__c'] = this.recordId;
                if(this.accOwnerId != this.userId){
                    fields['Is_Partner_Check_In__c'] = true;
                }
            }        
        fields['Check_In_Time__c'] = new Date().toISOString();
        fields['Check_In_Geolocation__Latitude__s'] = this.userLatitude; // Mahesh Reddy modified
        fields['Check_In_Geolocation__Longitude__s'] = this.userLongitude; // Mahesh Reddy modified
        ...
        .then(data =>{
            ...
            //this.displayCheckInBtn = true; //Mahesh Reddy added line
    ...
    handleAddressSelection(event) {
        ...
        if (this.currentObjectName == OppAPIName) {
            ...
            if(this.oppOwnerId != this.userId){
                fields['Is_Partner_Check_In__c'] = true;
                } // If condition is add by Mahesh Reddy
            }else{
                fields['Go_Live_Doctor__c'] = this.recordId;
                if(this.accOwnerId != this.userId){
                    fields['Is_Partner_Check_In__c'] = true;
    ...
    handleCheckOut(event) {
        ...
        fields['Partner_Check_Out_Time__c'] = new Date().toISOString();
        fields['Partner_Check_In_Count__c'] = this.currentRecCheckInCount + 1;
        ...
        updateRecord(recordInput)
            .then(() => {
                ...
                this.displayCheckOutBtn = false; // Un commented the code by Mahesh Reddy
                return refreshApex(this.currentRecord);
            })
            .catch(error => {
                this.dispatchEvent(
    ...
    geoDistance(uLatitude, uLongitude, recLatitude, recLongitude) {
        //geoDistance(uLatitude, uLongitude,17.416763955289, 78.3789010750096){
...
//  //Functions - End
//  @wire(getRecord, { recordId: '$recordId', fields: [OPPORTUNITY_STAGE_FIELD] })
//  wiredOpportunity({ error, data }) {
//      if (data) {
//          const stage = data.fields.StageName.value;

//          // Check if the Opportunity stage is "Closed"
//          this.showSignIn = stage === 'Closed';
//      } else if (error) {
//          // Handle error
//      }