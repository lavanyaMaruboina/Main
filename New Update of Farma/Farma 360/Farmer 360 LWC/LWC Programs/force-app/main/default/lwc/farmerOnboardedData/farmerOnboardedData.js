...
import fetchOnboardReportsData from '@salesforce/apex/updateLandDetails.fetchOnboardReportsData';
import userId from '@salesforce/schema/User.Id';

export default class FarmerOnboardedData extends LightningElement {
    ...
    connectedCallback() {
      ...
      loadChartData() {
        fetchOnboardReportsData({userId:this.userId})
          .then((data) => {
