...
//==============================File Uploaded======================================
 ...
 @track contactObj = {
    ...
    filterContacts(searchTerm) {
        this.contactDetails = this.allContacts.filter(contact => {
    ...
    fetchRecentContacts() {
        getRecentContacts()
            .then(result => {
                this.contactDetails = result.map(wrapper => {
                    return {
                        ...wrapper.contact,
                        imageUrl: wrapper.attachmentUrl
                    };
                });
                this.allContacts = [...this.contactDetails];
                console.log('All contacts with files >>>>>', JSON.stringify(this.contactDetails));
            })
            .catch(error => {
                this.error = error;
                console.error('Error fetching contacts with files:', error);
            });
    }
...
handleSave() {
    ...
    handleCardClick(event) {
        ...
        this.fetchFiles();
            ...
            this.contactObj.consent = selectedContact.Farmer_Consent__c;
    ...
    handleRowSelection(event) {
       ...
       this.contactObj.panCardNumber = selectedRow.PAN_Card__c;
        ...
        this.contactObj.consent =selectedRow.Farmer_Consent__c;
