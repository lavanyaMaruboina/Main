    ...
    await displayRepaymentInfo({ loanAppId: this.recordId ,dealId:this.dealId})
      .then((result) => {
        if (result != null) {
          ...
          if(this.eNachStatus !=='SUCCESS' && this.eNachStatus !=='FAILED' && eNachBtnClickTime != null && timeTenMinsAgo < eNachBtnClickTime){
            this.disableInitiateENACH = true;
            this.showTimer = true;
    ...
    displayRepaymentInfo({ loanAppId: this.recordId ,dealId:this.dealId})
        ...
        if (result != null) {
            ...
            if(this.eNachStatus==='SUCCESS'){
              ...
              this.showENACHSubmitButton=true;
            }else if(this.currentStep != 'final-offer' && this.eNachStatus === 'FAILED') {
