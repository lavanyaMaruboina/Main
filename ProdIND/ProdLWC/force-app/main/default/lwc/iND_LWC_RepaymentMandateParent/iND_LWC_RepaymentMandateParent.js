    ...
    await createRepaymentRecord({ loanApplicationId: this.recordId, data: data, dealId : this.dealId})
      .then((result) => {
        if (result != null) {
          ...
          if (this.eNachStatus === 'In Progress' || this.eNachStatus === 'ENACH Registration Success' || this.eNachStatus === 'Response From NPCI Pending' || this.eNachStatus === 'Customer Action On ENACH Pending') {//CFDI-1152
            this.eNachFlag = true;
            this.achFlag = false;
            this.siFlag = false;
            this.accordionActiveSection = "e-Nach";
          ...
          if (this.eNachStatus === 'ENACH Registration Failed') {
            this.eNachFlag = true;
            this.achFlag = false;
            this.siFlag = false;
            this.accordionActiveSection = "e-Nach";
